...
const Footer = () => {
	...
	const socialLinks = [
		...
		{
			name: 'GitHub',
			href: 'https://github.com/hugo-chilemme/pro-boulangerie-la-khobz-marocaine',
			icon: (
				<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="size-6">
		...
		<footer className="bg-white">
			<div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
				...
				<p className="mt-10 text-center text-sm/6 text-gray-600">
					&copy; {new Date().getFullYear()} La Khobz Marocaine. Tous droits réservés.
				</p>
				<p className="mt-2 text-center text-sm/6 text-gray-600">
					Site créé par <Link href="https://github.com/hugo-chilemme/pro-boulangerie-la-khobz-marocaine" className="hover:text-gray-900">Hugo Chilemme</Link>.
				</p>
			</div>
		</footer>
		<div className="bg-amber-100 py-4">
			<div className="container mx-auto px-4 text-center text-sm text-gray-800">
				<p>Ce site a été fait dans le cadre d&apos;un projet personnel. Tous les contenus et images sont utilisés à des fins démonstratives.</p>
			</div>
		</div>
		</>
	);
